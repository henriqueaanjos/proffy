...
import BackgroundSvg from '../../assets/backgroundProfile.svg';
...
export const ContentHeaderBackground = styled(BackgroundSvg)`
    width: 100%;
    position: absolute;
    top: 30px;
    left: auto;
...
export const ProfileImages = styled.View`
...
export const ProfileChangeImageButton = styled(RectButton)`
    width: 40px;
    height: 40px;
